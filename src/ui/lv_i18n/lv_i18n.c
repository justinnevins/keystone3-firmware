...
const static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"boot_secure_switch_btn", "Security Boot"},
    {"boot_secure_switch_desc", "Security Boot checks the firmware's security during system startup. Disabling this function may pose security risks"},
    {"boot_secure_switch_text_title", "Security Boot"},
    {"boot_secure_switch_title", "Security Boot"},
    {"boot_update_desc1", "The device will update to enhance security; please ensure readiness."},
    {"boot_update_desc2", "The device has at least 40% battery."},
    ...
    {"boot_version_not_match_desc", "Your current firmware may have skipped the necessary security upgrade, please contact #1BE0C6 support@keyst.one# for assistance."},
    ...
    {"chain_path_avax_c_desc", "C-Chain enables EVM-compatible DeFi and smart contracts."},
    {"chain_path_avax_x_p_desc", "X/P-Chain uses Bech32 for UTXO-based asset transfers and staking."},
    ...
    {"connect_backpack_title2", "Backpack (Mobile)"},
    {"connect_beacon_link", "https://keyst.one/t/3rd/beacon"},
    {"connect_beacon_title", "Beacon Wallet"},
    ...
    {"connect_mintscan_title", "Mintscan"},
    ...
    {"connect_vespr_link", "https://keyst.one/t/3rd/vespr"},
    {"connect_vespr_title", "Vespr"},
    ...
    {"connect_wallet_supported_wallet", "Supported Wallets"},
    ...
    {"connect_dexrp_link", "https://dexrp.me"},
    {"connect_dexrp_title", "DEXrp (Web)"},
    ...
    {"connect_zashi_link", "https://keyst.one/t/3rd/zashi"},
    {"connect_zashi_title", "Zashi"},
    {"connect_zeus_link", "https://keyst.one/t/3rd/zeus"},
    {"connect_zeus_title", "Zeus (Mobile)"},
    ...
    {"create_multi_wallet_co_sign_text", "Co-Sign"},
    ...
    {"derivation_path_ltc_native_desc", "addresses start with a \"ltc1\"Addresses eg."},
    {"derivation_path_ltc_nested_desc", "addresses start with a \"M\"Addresses eg."},
    ...
    {"derivation_path_select_avax", "Select the Avalanche Chain relevant to your transaction"},
    ...
    {"derivation_path_select_ltc", "Select the address type you’d like to use for Litcoin"},
    ...
    {"error_box_low_power_desc", "The device needs a minimum of 40% battery life to continue the process."},
    ...
    {"firmware_update_desc1", "Ensure that your Keystone has at least 40% battery life remaining."},
    ...
    {"import_ton_mnemonic_desc", "The seed phrase matches both BIP39 and TON formats. Please select the type of wallet you want to create: Multi-Coin Wallet or TON-Only Wallet."},
    {"import_ton_mnemonic_title", "Choose Your Wallet"},
    ...
    {"instruction_does_not_contain_token_info", "In this SOL transaction raw data does not specify the exact token type and mint address. Please confirm the specific token type in the software wallet."},
    ...
    {"invaild_ada_path", "Path Not Supported"},
    {"invaild_ada_path_con", "The selected path is not supported.Please choose a vaild path on the software wallet."},
    {"invaild_derive_type", "Invaild Derive Type"},
    {"invaild_derive_type_con", "unsupport derivation type"},
    {"invaild_path_index_big", "ada derivation path index is too large"},
    {"invaild_path_index_con", "ada derivation path is illegal"},
    {"invaild_path_index_title", "Invaild Path Index"},
    {"invaild_schemas_size", "Invaild Schemas Size"},
    {"invaild_schemas_size_big", "schemas size is too large"},
    {"invalid_slip39_ada_con", "Shamir Backup wallet doesn't support Cardano at the moment"},
    {"iota_max_amount_notice", "In object-based models like IOTA, Max means transferring ownership of the entire coin, so no specific amount is shown."},
    ...
    {"manage_import_wallet_passphrase_error_desc", "Unable to import multisig wallet into the Passphrase wallet. Please confirm Passphrase and retry."},
    ...
    {"manage_multi_wallet_passphrase_add_limit_desc", "Add up to 1 passphrase multisig wallets"},
    ...
    {"nft_screen_set_success_desc", "You can turn off or on the NFT screensaver display in System Settings."},
    {"nft_screen_set_success_title", "Setup Successful"},
    ...
    {"power_requirements_hintbox_context", "Ensure the device has at least 80% battery and is connected to a power source to proceed."},
    ...
    {"receive_doge_receive_change_address_limit", "Can't exceed 19"},
    ...
    {"receive_ltc_more_t_desc1", "1. Nested SegWit: A transitional format where SegWit is nested inside P2SH. It offers better efficiency than Legacy and is the most commonly used format due to broad compatibility. \r\n2.Native SegWit: Fully native SegWit format with lower fees and smaller transaction sizes. Increasingly popular and supported by most major wallets and exchanges"},
    {"receive_ltc_more_t_title1", "Know The Difference: Nested SegWit, and  Native SegWit Derivation Paths in LTC"},
    ...
    {"recovery_mode_switch_desc", "When enabled, you can enter Recovery Mode, proceed only if you need to recover your system."},
    {"recovery_mode_switch_text_title", "Recovery Mode"},
    {"recovery_mode_switch_title", "Recovery Mode"},
    ...
    {"rsa_confirm_hintbox_context", "Please enter your password to start the ARWEAVE blockchain setup which will take about 10 minutes. Ensure your device is at least 80% charged and connected to USB power."},
    ...
    {"sign_eth_operation_warn", "This operation/transaction may alter the internal state of the multisig contract. Please review the details carefully."},
    ...
    {"single_phrase_low_battery_desc", "The device needs a minimum of 40% battery life to continue the process"},
    ...
    {"solana_squads_amount_desc", "This amount is the deploy fee, consisting of three parts. For details, please refer to the Squads Official Website."},
    ...
    {"system_settings_random_pin_pad", "Randomized PIN Pad"},
    ...
    {"tap_to_see_more", "··· Tap to see more wallets"},
    ...
    {"ton_assets_manage_notice", "The TON wallet does not support adding other mainnets like Bitcoin or Ethereum due to incompatible seed phrase."},
    ...
    {"tutorial_suiet_link", "https://keyst.one/t/3rd/suiet"},
    {"tutorial_suiet_title", "Suiet Wallet"},
    ...
    {"usb_connection_notice", "Connection Notice"},
    {"usb_connection_notice_desc", "%s Wallet QR code connection is not available now.Please connect via USB instead."},
    ...
    {"wallet_profile_single_sign_title_text", "Single-Sig Wallet"},
...
const static lv_i18n_phrase_t de_singulars[] = {
    ...
    {"beta_version_notice_title", "Beta-Version"},
    {"boot_secure_switch_btn", "Boot-Sicherheitsprüfung"},
    {"boot_secure_switch_desc", "Das Deaktivieren des Sicherheitsstarts kann Sicherheitsrisiken verursachen."},
    {"boot_secure_switch_text_title", "Boot-Sicherheitsprüfung"},
    {"boot_secure_switch_title", "Boot-Sicherheitsprüfung"},
    {"boot_update_desc1", "Das Gerät wird für mehr Sicherheit aktualisiert."},
    {"boot_update_desc2", "Die Batterie hat mindestens 40%"},
    {"boot_update_desc3", "Netzteil angeschlossen"},
    {"boot_update_desc4", "Dauer: bis zu 5 Minuten. Strom NICHT trennen oder etwas tun."},
    {"boot_update_desc5", "Kontaktieren Sie uns"},
    {"boot_update_limit_desc", "Stellen Sie sicher, dass das Gerät mindestens 40% Batterie hat und an eine Stromquelle angeschlossen ist, um fortzufahren."},
    {"boot_update_process_desc", "Das Gerät wird aktualisiert, um die Sicherheit zu verbessern. Trennen Sie die Stromquelle nicht oder führen Sie keine Operationen aus."},
    {"boot_update_process_title", "Sicherheitsupdate läuft..."},
    {"boot_update_title", "Sicherheitsupgrade"},
    {"boot_version_not_match_desc", "Ihre aktuelle Firmware hat möglicherweise das erforderliche Sicherheitsupdate übersprungen. Bitte kontaktieren Sie #1BE0C6 support@keyst.one# um Unterstützung zu erhalten."},
    ...
    {"chain_path_avax_c_desc", "C-Chain ermöglicht EVM-kompatible DeFi und Smart Contracts."},
    {"chain_path_avax_x_p_desc", "X/P-Chain verwendet Bech32 für UTXO-basierte Asset-Transfers und Staking."},
    ...
    {"connect_wallet_supported_wallet", "Unterstützte Wallets"},
    ...
    {"create_multi_wallet_co_sign_text", "Mitunterschreiben"},
    ...
    {"derivation_path_ltc_native_desc", "Adressen beginnen mit „ltc1“"},
    {"derivation_path_ltc_nested_desc", "Adressen beginnen mit „M“"},
    ...
    {"derivation_path_select_avax", "Wählen Sie die für Ihre Transaktion relevante Avalanche-Chain aus"},
    ...
    {"derivation_path_select_ltc", "Wählen Sie den Adresstyp aus, den Sie für Litcoin verwenden möchten."},
    ...
    {"error_box_low_power_desc", "Das Gerät benötigt mindestens 40% Akkuladung"},
    ...
    {"import_ton_mnemonic_desc", "Die Seed-Phrase entspricht sowohl dem BIP39- als auch dem TON-Format. Bitte wählen Sie den Typ der Wallet, die Sie erstellen möchten: Multi-Coin-Wallet oder nur TON-Wallet."},
    {"import_ton_mnemonic_title", "Wählen Sie Ihre Wallet"},
    ...
    {"instruction_does_not_contain_token_info", "In den Rohdaten dieser SOL-Transaktion wird der genaue Token-Typ und die Mint-Adresse nicht angegeben. Bitte bestätigen Sie den spezifischen Token-Typ in der Software-Wallet."},
    ...
    {"invaild_ada_path", "Der Pfad wird nicht unterstützt"},
    {"invaild_ada_path_con", "Der ausgewählte Pfad wird nicht unterstützt. Bitte wählen Sie einen gültigen Pfad in der Software-Wallet."},
    {"invaild_derive_type", "Ungültiger Ableitungstyp"},
    {"invaild_derive_type_con", "Nicht unterstützter Ableitungstyp"},
    {"invaild_path_index_big", "Der ada-Ableitungspfadindex ist zu groß"},
    {"invaild_path_index_con", "Der ada-Ableitungspfad ist ungültig"},
    {"invaild_path_index_title", "Ungültiger Pfadindex"},
    {"invaild_schemas_size", "Ungültige Schemagröße"},
    {"invaild_schemas_size_big", "Die Schemagröße ist zu groß"},
    {"invalid_slip39_ada_con", "Shamir Backup-Wallet unterstützt derzeit Cardano nicht"},
    {"iota_max_amount_notice", "In object-based models like IOTA, Max means transferring ownership of the entire coin, so no specific amount is shown."},
    ...
    {"manage_import_wallet_passphrase_error_desc", "Multisig-Import fehlgeschlagen. Bitte Passphrase prüfen und erneut versuchen."},
    ...
    {"manage_multi_wallet_passphrase_add_limit_desc", "Bis zu 1 Passphrase für Multisig-Wallets hinzufügen"},
    ...
    {"nft_screen_set_success_desc", "Sie können den NFT-Bildschirmschoner in den Systemeinstellungen ein- oder ausschalten"},
    {"nft_screen_set_success_title", "Einrichtung erfolgreich"},
    {"nft_screen_set_title", "Wie richtet man einen NFT-Bildschirmschoner ein?"},
    {"nft_screen_set_url", "https://keyst.one/t/3rd/nft"},
    {"nft_trans_title", "Übertragen..."},
    {"nft_trans_updating_desc", "Dauert etwa 1 Minuten"},
    {"nft_trans_updating_hint", "Trennen Sie das USB-Kabel während des Übertragungsvorgangs nicht"},
    ...
    {"power_requirements_hintbox_cancel", "OK"},
    {"power_requirements_hintbox_context", "Stellen Sie sicher, dass das Gerät mindestens 80% Akkuladung hat und an eine Stromquelle angeschlossen ist, um fortzufahren."},
    ...
    {"receive_doge_receive_change_address_limit", "Kann nicht den Wert von 19 überschreiten."},
    ...
    {"receive_ltc_more_t_desc1", "1.Nested SegWit: ein Übergangsformat, bei dem SegWit in P2SH eingebettet ist. Es bietet eine bessere Effizienz als Legacy und ist aufgrund der breiten Kompatibilität das am häufigsten verwendete Format.\r\n2.Native SegWit: vollständig natives SegWit-Format mit niedrigeren Gebühren und kleineren Transaktionsgrößen. Wird zunehmend beliebter und wird von den meisten großen Wallets und Börsen unterstützt."},
    {"receive_ltc_more_t_title1", "Erkennen Sie den Unterschied: Verschachtelte SegWit- und Native SegWit-Ableitungspfade in LTC"},
    {"receive_more_t_qr_link", "https://keyst.one/t/3rd/faq"},
    ...
    {"recovery_mode_switch_desc", "Wenn diese Funktion aktiviert ist, können Sie den Wiederherstellungsmodus eingeben, fahren Sie nur fort, wenn Sie Ihr System wiederherstellen müssen."},
    {"recovery_mode_switch_text_title", "Wiederherstellungsmodus"},
    {"recovery_mode_switch_title", "Wiederherstellungsmodus"},
    ...
    {"rsa_confirm_hintbox_context", "Bitte geben Sie Ihr Passwort ein, um die Einrichtung der ARWEAVE Blockchain zu starten, die etwa 10 Minuten dauern wird. Stellen Sie sicher, dass Ihr Gerät mindestens zu 80% geladen und mit USB-Strom verbunden ist."},
    ...
    {"sign_eth_operation_warn", "Diese Operation/Transaktion kann den internen Zustand des Multisig-Vertrags verändern. Bitte überprüfe die Details sorgfältig."},
    ...
    {"single_phrase_low_battery_desc", "Das Gerät benötigt mindestens 40% Batterielebensdauer, um den Vorgang fortzusetzen."},
    ...
    {"solana_squads_amount_desc", "Dieser Betrag ist die Bereitstellungsgebühr und besteht aus drei Teilen. Für weitere Details besuchen Sie bitte die offizielle Website von Squads."},
    ...
    {"system_settings_random_pin_pad", "Zufällige PIN-Tastatur"},
    ...
    {"tap_to_see_more", "··· Tippen Sie, um weitere Wallets zu sehen"},
    {"token_details", "Token-Details"},
    ...
    {"ton_assets_manage_notice", "Die TON-Wallet unterstützt das Hinzufügen anderer Mainnets wie Bitcoin oder Ethereum aufgrund inkompatibler Seed-Phrasen nicht."},
    ...
    {"usb_connection_notice", "Verbindungshinweis"},
    {"usb_connection_notice_desc", "%s Wallet QR code connection is not available now.Please connect via USB instead."},
    {"usb_connection_subtitle", "Air-Gap-Modus"},
    {"usb_connection_title", "Verbindung"},
    {"usb_connectioning_wallet_desc", "Bitte warten Sie, bis die Software-Wallet die Verbindung hergestellt hat, und klicken Sie dann zum Schließen."},
    {"usb_connectioning_wallet_title", "Wallet wird verbunden"},
    {"usb_transport_connect_desc", "Die Software-Wallet möchte eine Verbindung zu Ihrem Keystone über USB herstellen. Geben Sie Ihr Passwort ein, um dies zu genehmigen"},
    ...
    {"wallet_profile_single_sign_title_text", "Einzelsig-Geldbörse"},
...
const static lv_i18n_phrase_t es_singulars[] = {
    ...
    {"boot_secure_switch_btn", "Verificar arranque seguro"},
    {"boot_secure_switch_desc", "Desactivar el arranque seguro puede generar riesgos de seguridad."},
    {"boot_secure_switch_text_title", "Comprobar seguridad de arranque"},
    {"boot_secure_switch_title", "Comprobar seguridad de arranque"},
    {"boot_update_desc1", "El dispositivo se actualizará para mejorar la seguridad; asegúrese de que está listo."},
    {"boot_update_desc2", "La batería tiene al menos 40%"},
    {"boot_update_desc3", "Netzteil angeschlossen"},
    {"boot_update_desc4", "Tarda hasta 5 minutos. NO desconecte ni use el dispositivo."},
    {"boot_update_desc5", "Contact us"},
    {"boot_update_limit_desc", "Asegúrese de que el dispositivo tenga al menos 40% de batería y esté conectado a una fuente de alimentación para continuar."},
    {"boot_update_process_desc", "El dispositivo está actualizando para mejorar la seguridad. No desconecte la fuente de alimentación o realice cualquier operación."},
    {"boot_update_process_title", "Actualizando seguridad..."},
    {"boot_update_title", "Actualización de seguridad"},
    {"boot_version_not_match_desc", "Es posible que su firmware actual haya omitido la actualización de seguridad necesaria. Por favor, contacte a #1BE0C6 support@keyst.one# para obtener asistencia."},
    ...
    {"chain_path_avax_c_desc", "C-Chain habilita DeFi y contratos inteligentes compatibles con EVM."},
    {"chain_path_avax_x_p_desc", "X/P-Chain utiliza Bech32 para transferencias de activos basadas en UTXO y staking."},
    ...
    {"connect_wallet_supported_wallet", "Billeteras compatibles"},
    ...
    {"create_multi_wallet_co_sign_text", "Co-firmar"},
    ...
    {"derivation_path_ltc_native_desc", "Las direcciones comienzan con ltc1\"\""},
    {"derivation_path_ltc_nested_desc", "Las direcciones comienzan con M\"\""},
    ...
    {"derivation_path_select_avax", "Seleccione la cadena de Avalanche relevante para su transacción."},
    ...
    {"derivation_path_select_ltc", "Selecciona el tipo de dirección que deseas usar para Litcoin"},
    ...
    {"error_box_low_power_desc", "El dispositivo necesita un mínimo del 40% de batería para continuar el proceso."},
    ...
    {"firmware_update_desc1", "Asegúrate de que tu Keystone tenga al menos un 40% de batería restante"},
    ...
    {"import_ton_mnemonic_desc", "La frase semilla coincide con los formatos BIP39 y TON. Por favor, seleccione el tipo de billetera que desea crear: Billetera Multimoneda o Billetera Solo TON."},
    {"import_ton_mnemonic_title", "Elige tu billetera"},
    ...
    {"instruction_does_not_contain_token_info", "En los datos sin procesar de esta transacción SOL no se especifica el tipo exacto de token ni la dirección de acuñación. Por favor, confirme el tipo específico de token en la billetera de software."},
    ...
    {"invaild_ada_path", "La ruta no es compatible"},
    {"invaild_ada_path_con", "El camino seleccionado no es compatible. Por favor, elija un camino válido en la billetera de software."},
    {"invaild_derive_type", "Tipo de derivación no válido"},
    {"invaild_derive_type_con", "Tipo de derivación no compatible"},
    {"invaild_path_index_big", "El índice de ruta de derivación ada es demasiado grande"},
    {"invaild_path_index_con", "La ruta de derivación ada es ilegal"},
    {"invaild_path_index_title", "Índice de ruta no válido"},
    {"invaild_schemas_size", "Tamaño de esquemas no válido"},
    {"invaild_schemas_size_big", "El tamaño de los esquemas es demasiado grande"},
    {"invalid_slip39_ada_con", "La billetera de respaldo Shamir no admite Cardano en este momento"},
    {"iota_max_amount_notice", "En modelos basados en objetos como IOTA, Max significa transferir la propiedad de toda la moneda, por lo que no se muestra una cantidad específica."},
    ...
    {"manage_import_wallet_passphrase_error_desc", "Error al importar multisig; confirme la frase y reintente."},
    ...
    {"manage_multi_wallet_passphrase_add_limit_desc", "Agregar hasta 1 frase de contraseña en carteras multisig"},
    ...
    {"nft_screen_set_success_desc", "Puedes activar o desactivar la pantalla de protector de pantalla NFT en Configuración del sistema"},
    {"nft_screen_set_success_title", "Configuración exitosa"},
    {"nft_screen_set_title", "¿Cómo configurar el protector de pantalla NFT?"},
    {"nft_screen_set_url", "https://keyst.one/t/3rd/nft"},
    {"nft_trans_title", "Transfiriendo..."},
    {"nft_trans_updating_desc", "Tarda alrededor de 1 minutos"},
    {"nft_trans_updating_hint", "No desconecte el cable USB durante el proceso de transferencia"},
    ...
    {"power_off", "Apagar"},
    {"power_requirements_hintbox_cancel", "OK"},
    {"power_requirements_hintbox_context", "Asegúrese de que el dispositivo tenga al menos un 80% de batería y esté conectado a una fuente de energía para continuar."},
    {"power_requirements_hintbox_title", "Leistungsanforderungen"},
    ...
    {"receive_doge_receive_change_address_limit", "No puede exceder los 19"},
    ...
    {"receive_ltc_more_t_desc1", "1.Nested SegWit: un formato transicional donde SegWit está anidado dentro de P2SH. Ofrece mayor eficiencia que Legacy y es el formato más utilizado debido a su amplia compatibilidad.\r\n2.Native SegWit: formato SegWit totalmente nativo con tarifas más bajas y tamaños de transacción más pequeños. Cada vez más popular y compatible con la mayoría de las principales billeteras y exchanges."},
    {"receive_ltc_more_t_title1", "Conozca la diferencia: rutas de derivación Nested SegWit y Native SegWit en LTC"},
    {"receive_more_t_qr_link", "https://keyst.one/t/3rd/faq"},
    ...
    {"recovery_mode_switch_desc", "Al activar esta función, puede entrar en el modo de recuperación, continúe solo si necesita recuperar su sistema."},
    {"recovery_mode_switch_text_title", "Modo de recuperación"},
    {"recovery_mode_switch_title", "Modo de recuperación"},
    ...
    {"rsa_confirm_hintbox_context", "Por favor, introduzca su contraseña para iniciar la configuración de la blockchain ARWEAVE, la cual tomará aproximadamente 10 minutos. Asegúrese de que su dispositivo tenga al menos un 80% de carga y esté conectado a una fuente de energía USB."},
    ...
    {"sign_eth_operation_warn", "Esta operación/transacción puede alterar el estado interno del contrato multifirma. Por favor, revisa los detalles cuidadosamente."},
    ...
    {"single_phrase_low_battery_desc", "El dispositivo necesita un mínimo del 40% de batería para continuar el proceso"},
    ...
    {"solana_squads_amount_desc", "Este monto es la tarifa de despliegue, que consta de tres partes. Para más detalles, por favor consulte el sitio web oficial de Squads."},
    ...
    {"system_settings_random_pin_pad", "Teclado PIN aleatorio"},
    ...
    {"tap_to_see_more", "··· Toca para ver más billeteras"},
    ...
    {"ton_assets_manage_notice", "La billetera TON no admite agregar otras redes principales como Bitcoin o Ethereum debido a la frase semilla incompatible."},
    ...
    {"usb_connection_notice", "Aviso de conexión"},
    {"usb_connection_notice_desc", "%s Wallet QR code connection is not available now.Please connect via USB instead."},
    {"usb_connection_subtitle", "Modo Air-Gap"},
    {"usb_connection_title", "Conexión"},
    {"usb_connectioning_wallet_desc", "Por favor, espere hasta que la billetera de software haya completado la conexión, luego haga clic para cerrar."},
    {"usb_connectioning_wallet_title", "Conectando la billetera"},
    {"usb_transport_connect_desc", "La billetera de software está solicitando conectarse a su Keystone a través de USB. Ingrese su contraseña para aprobar"},
    ...
    {"wallet_profile_single_sign_title_text", "Billetera Single-Sig"},
...
const static lv_i18n_phrase_t ja_singulars[] = {
    ...
    {"boot_secure_switch_btn", "ブートセキュリティチェック"},
    {"boot_secure_switch_desc", "セキュアブートを無効にすると、セキュリティリスクが生じる可能性があります。"},
    {"boot_secure_switch_text_title", "ブートセキュリティチェック"},
    {"boot_secure_switch_title", "ブートセキュリティチェック"},
    {"boot_update_desc1", "デバイスはセキュリティを向上させるために更新されます。準備ができていることを確認してください。"},
    {"boot_update_desc2", "バッテリーは少なくとも40%以上"},
    {"boot_update_desc3", "·電源接続"},
    {"boot_update_desc4", "この処理には最大で5分かかる場合があります。電源を切ったり操作を行ったりしないでください。"},
    {"boot_update_desc5", "お問い合わせ"},
    {"boot_update_limit_desc", "デバイスが少なくとも40%のバッテリーを持ち、電源ソースに接続されていることを確認してください。"},
    {"boot_update_process_desc", "デバイスはセキュリティを向上させるために更新されています。電源を切らないでください。また、操作を行わないでください。"},
    {"boot_update_process_title", "セキュリティ更新中..."},
    {"boot_update_title", "セキュリティアップグレード"},
    {"boot_version_not_match_desc", "現在のファームウェアが必要なセキュリティアップグレードをスキップしている可能性があります。サポートを受けるには、 #1BE0C6 support@keyst.one # にご連絡ください。"},
    ...
    {"chain_path_avax_c_desc", "C-ChainはEVM互換のDeFiとスマートコントラクトを可能にします."},
    {"chain_path_avax_x_p_desc", "X/P-ChainはUTXOベースの資産転送とステーキングにBech32を使用します。"},
    ...
    {"connect_wallet_supported_wallet", "サポートされているウォレット"},
    ...
    {"create_multi_wallet_co_sign_text", "共同署名"},
    ...
    {"error_box_low_power_desc", " um den Vorgang fortzusetzen."},
    ...
    {"firmware_update_desc1", "Keystoneが少なくとも40%のバッテリー残量を確保してください."},
    ...
    {"import_ton_mnemonic_desc", "シードフレーズはBIP39およびTON形式の両方に対応しています。作成したいウォレットのタイプを選択してください: マルチコインウォレットまたはTON専用ウォレット。"},
    {"import_ton_mnemonic_title", "ウォレットを選択してください"},
    ...
    {"instruction_does_not_contain_token_info", "この SOL トランザクションの生データには正確なトークンタイプと発行アドレスが指定されていません。ソフトウェアウォレットで具体的なトークンタイプを確認してください。"},
    {"invaild_account_path", "無効なアカウントパス"},
    {"invaild_account_path_notice", "ソフトウェアウォレットでパスを再入力してもう一度試してください。"},
    {"invaild_ada_path", "パスがサポートされていません"},
    {"invaild_ada_path_con", "選択したパスはサポートされていません。ソフトウェアウォレットで有効なパスを選択してください。"},
    {"invaild_derive_type", "無効な派生タイプ"},
    {"invaild_derive_type_con", "サポートされていない派生タイプ"},
    {"invaild_path_index_big", "ada 派生パスインデックスが大きすぎます"},
    {"invaild_path_index_con", "ada 派生パスが不正です"},
    {"invaild_path_index_title", "無効なパスインデックス"},
    {"invaild_schemas_size", "無効なスキーマサイズ"},
    {"invaild_schemas_size_big", "スキーマサイズが大きすぎます"},
    {"invalid_slip39_ada_con", "Shamirバックアップウォレットは現在Cardanoをサポートしていません"},
    {"iota_max_amount_notice", "IOTAのようなオブジェクトベースのモデルでは、Maxは全体のコインの所有権を移転することを意味するため、具体的な金額は表示されません。"},
    ...
    {"manage_import_wallet_passphrase_error_desc", "マルチシグのインポート失敗。パスフレーズを確認し再試行してください。"},
    ...
    {"manage_multi_wallet_passphrase_add_limit_desc", "1つのパスフレーズマルチシグウォレットを追加"},
    ...
    {"nft_screen_saver_desc", "設定が成功すると、選択したNFTがロック画面に表示されます"},
    {"nft_screen_saver_title", "NFTをホーム画面に設定する"},
    {"nft_screen_set_success_desc", "システム設定でNFTスクリーンセーバー表示をオンまたはオフにできます"},
    {"nft_screen_set_success_title", "設定が成功しました"},
    {"nft_screen_set_title", "NFTスクリーンセーバーの設定方法は?"},
    {"nft_screen_set_url", "https://keyst.one/t/3rd/nft"},
    {"nft_trans_title", "転送中..."},
    {"nft_trans_updating_desc", "約1分かかります"},
    {"nft_trans_updating_hint", "転送中はUSBケーブルを外さないでください"},
    ...
    {"receive_doge_receive_change_address_limit", "19 を超えることはできません."},
    ...
    {"receive_ltc_more_t_desc1", "1.Nested SegWit：SegWit を P2SH 内にネストした移行形式です。Legacy より効率的で、幅広い互換性により最も一般的に使用されている形式です。\r\n2.Native SegWit：完全にネイティブな SegWit 形式で、手数料が低く、トランザクションサイズも小さくなります。主要なウォレットや取引所のほとんどでサポートされ、ますます普及しています。"},
    {"receive_ltc_more_t_title1", "違いを知ろう：LTC における Nested SegWit と Native SegWit の派生パス"},
    {"receive_more_t_qr_link", "https://keyst.one/t/3rd/faq"},
    ...
    {"recovery_mode_switch_desc", "この機能を有効にすると、回復モードに入ることができます。システムを回復する必要がある場合にのみ続行してください。"},
    {"recovery_mode_switch_text_title", "回復モード"},
    {"recovery_mode_switch_title", "回復モード"},
    ...
    {"sign_eth_operation_warn", "この操作/トランザクションはマルチシグ契約の内部状態を変更する可能性があります。詳細を慎重に確認してください。"},
    ...
    {"single_phrase_low_battery_desc", "デバイスはプロセスを続行するために最低40%のバッテリー残量が必要です."},
    ...
    {"solana_squads_amount_desc", "この金額はデプロイ料金であり、3つの部分で構成されています。詳細については、Squads公式ウェブサイトを参照してください。"},
    ...
    {"system_settings_random_pin_pad", "ランダム化PINパッド"},
    ...
    {"tap_to_see_more", "··· タップして他のウォレットを見る"},
    {"token_details", "トークンの詳細"},
    {"token_in_alt_desc", "この SOL トランザクションの生データには正確なトークンタイプが指定されていません。ソフトウェアウォレットで具体的なトークンタイプを確認してください。"},
    {"ton_assets_manage_notice", "TONウォレットは、互換性のないシードフレーズのため、BitcoinやEthereumなどの他のメインネットの追加をサポートしていません。"},
    ...
    {"usb_connection_notice", "接続通知"},
    {"usb_connection_notice_desc", "%s ウォレット QR コード接続は現在利用できません。USB を使用して接続してください。"},
    {"usb_connection_subtitle", "エアギャップモード"},
    {"usb_connection_title", "接続"},
    {"usb_connectioning_wallet_desc", "ソフトウェアウォレットが接続を完了するまでお待ちください。その後、クリックして閉じてください。"},
    {"usb_connectioning_wallet_title", "ウォレット接続中"},
    {"usb_transport_connect_desc", "ソフトウェアウォレットがUSB経由であなたのKeystoneに接続を要求しています。承認するにはパスワードを入力してください"},
    ...
    {"wallet_profile_single_sign_title_text", "単一署名ウォレット"},
...
const static lv_i18n_phrase_t ko_singulars[] = {
    ...
    {"boot_secure_switch_btn", "부트 보안 확인"},
    {"boot_secure_switch_desc", "보안 부팅을 활성화하면 보안 위험이 발생할 수 있습니다."},
    {"boot_secure_switch_text_title", "부트 보안 확인"},
    {"boot_secure_switch_title", "부트 보안 확인"},
    {"boot_update_desc1", "장치가 보안을 강화하기 위해 업데이트될 것입니다. 준비가 되었는지 확인하세요."},
    {"boot_update_desc2", "배터리 최소 40%"},
    {"boot_update_desc3", "전원 어댑터 연결"},
    {"boot_update_desc4", "이 프로세스는 최대 5분이 걸릴 수 있습니다. 전원을 끄거나 작업을 수행하지 마세요."},
    {"boot_update_desc5", "연락처"},
    {"boot_update_limit_desc", "장치가 최소 #F5870A 40%# 배터리를 갖고 전원 소스에 연결되어 있는지 확인하세요."},
    {"boot_update_process_desc", "장치가 보안을 강화하기 위해 업데이트되고 있습니다. 전원을 끄거나 작업을 수행하지 마세요."},
    {"boot_update_process_title", "보안 업데이트가 진행 중입니다..."},
    {"boot_update_title", "보안 업그레이드"},
    {"boot_version_not_match_desc", "현재 펌웨어가 필수 보안 업그레이드를 건너뛴 것 같습니다. 도움을 받으려면 #1BE0C6 support@keyst.one#에 연락해 주세요"},
    ...
    {"chain_path_avax_c_desc", "C-Chain은 EVM 호환 DeFi 및 스마트 계약을 지원합니다."},
    {"chain_path_avax_x_p_desc", "X/P-Chain는 UTXO 기반 자산 전송 및 스테이킹에 Bech32를 사용합니다."},
    ...
    {"connect_wallet_supported_wallet", "지원되는 지갑"},
    ...
    {"create_multi_wallet_co_sign_text", "공동 서명"},
    ...
    {"device_settings_connection_desc1", "활성화된 경우 USB는 배터리 충전에만 사용할 수 있습니다"},
    ...
    {"error_box_low_power_desc", "이 장치는 프로세스를 계속하려면 최소 40%의 배터리 잔량이 필요합니다."},
    ...
    {"import_ton_mnemonic_desc", "시드 문구는 BIP39 및 TON 형식 모두에 일치합니다. 생성하려는 지갑 유형을 선택하십시오: 멀티 코인 지갑 또는 TON 전용 지갑."},
    {"import_ton_mnemonic_title", "지갑을 선택하세요"},
    ...
    {"instruction_does_not_contain_token_info", "이 SOL 트랜잭션의 원시 데이터에는 정확한 토큰 유형과 발행 주소가 지정되어 있지 않습니다. 소프트웨어 지갑에서 특정 토큰 유형을 확인하십시오."},
    {"invaild_account_path", "잘못된 계정 경로"},
    {"invaild_account_path_notice", "소프트웨어 지갑에 경로를 다시 입력하고 다시 시도하십시오."},
    {"invaild_ada_path", "경로를 지원하지 않습니다"},
    {"invaild_ada_path_con", "선택한 경로를 지원하지 않습니다. 소프트웨어 지갑에서 유효한 경로를 선택하세요."},
    {"invaild_derive_type", "잘못된 파생 유형"},
    {"invaild_derive_type_con", "지원되지 않는 파생 유형"},
    {"invaild_path_index_big", "ada 파생 경로 인덱스가 너무 큽니다"},
    {"invaild_path_index_con", "ada 파생 경로가 잘못되었습니다"},
    {"invaild_path_index_title", "잘못된 경로 인덱스"},
    {"invaild_schemas_size", "잘못된 스키마 크기"},
    {"invaild_schemas_size_big", "스키마 크기가 너무 큽니다"},
    {"invalid_slip39_ada_con", "Shamir 백업 지갑은 현재 Cardano를 지원하지 않습니다"},
    {"iota_max_amount_notice", "객체 기반 모델(IOTA)에서 Max는 전체 코인의 소유권을 이전하는 것을 의미하므로 구체적인 금액이 표시되지 않습니다."},
    {"language_desc", "언어 선택"},
    ...
    {"manage_import_wallet_passphrase_error_desc", "멀티시그 지갑 가져오기 실패. 암호 확인 후 재시도하세요."},
    ...
    {"manage_multi_wallet_passphrase_add_limit_desc", "1개의 패스프레이즈 멀티시그 지갑 추가"},
    ...
    {"nft_screen_saver_desc", "성공적으로 설정되면, 잠금 화면에 선택한 NFT가 표시됩니다"},
    {"nft_screen_saver_title", "NFT를 홈 화면으로 설정하다"},
    {"nft_screen_set_success_desc", "시스템 설정에서 NFT 화면 보호기 표시를 켜거나 끌 수 있습니다"},
    {"nft_screen_set_success_title", "설정 성공"},
    {"nft_screen_set_title", "NFT 화면 보호기를 설정하는 방법은?"},
    {"nft_screen_set_url", "https://keyst.one/t/3rd/nft"},
    {"nft_trans_title", "전송 중..."},
    {"nft_trans_updating_desc", "약 1분 걸립니다"},
    {"nft_trans_updating_hint", "USB 케이블을 전송 중에 분리하지 마십시오"},
    ...
    {"power_requirements_hintbox_context", "장치가 최소 80% 이상 충전되어 있고 전원에 연결되어 있는지 확인해 주세요."},
    ...
    {"receive_doge_receive_change_address_limit", "19 초과할 수 없습니다."},
    ...
    {"receive_ltc_more_t_desc1", "1.Nested SegWit: SegWit이 P2SH 안에 중첩된 과도기적 형식입니다. Legacy보다 효율성이 뛰어나며, 광범위한 호환성 덕분에 가장 일반적으로 사용되는 형식입니다.\r\n2.Native SegWit: 완전한 네이티브 SegWit 형식으로, 수수료가 더 낮고 거래 크기가 더 작습니다. 점점 더 인기를 얻고 있으며 대부분의 주요 지갑과 거래소에서 지원됩니다."},
    {"receive_ltc_more_t_title1", "차이를 알아보기: LTC에서 Nested SegWit 및 Native SegWit 파생 경로"},
    {"receive_more_t_qr_link", "https://keyst.one/t/3rd/faq"},
    ...
    {"recovery_mode_switch_desc", "이 기능을 활성화하면 복구 모드에 진입할 수 있습니다. 시스템을 복구해야 하는 경우에만 진행하세요."},
    {"recovery_mode_switch_text_title", "복구 모드"},
    {"recovery_mode_switch_title", "복구 모드"},
    {"repeat_passcode_desc", "입력한 PIN 코드를 다시 확인합니다."},
    {"repeat_passcode_title", "PIN 코드 다시 입력하십시오."},
    {"rsa_confirm_hintbox_cancel", "지금은 아니에요"},
    {"rsa_confirm_hintbox_context", "ARWEAVE 블록체인 설정을 시작하려면 비밀번호를 입력해 주세요. 프로세스는 약 10분이 소요됩니다. 장치가 최소 80% 충전되어 있고 USB 전원에 연결되어 있는지 확인하세요."},
    ...
    {"scan_qr_code_sign_unsigned_content_fingerprint_failed_desc2", "검증에 다시 실패하면 거래에 대한 지문 서명이 자동으로 활성화됩니다."},
    ...
    {"sign_eth_operation_warn", "이 작업/거래는 멀티시그 계약의 내부 상태를 변경할 수 있습니다. 세부 사항을 신중히 검토해 주세요."},
    {"sign_eth_permit_deny_sing", "Permit 서명이 현재 활성화되어 있습니다. 서명하기 전에 설정에서 활성화해 주세요."},
    ...
    {"single_phrase_low_battery_desc", "장치 배터리가 40% 이상인지 확인하십시오."},
    ...
    {"solana_squads_amount_desc", "이 금액은 배포 수수료로 세 부분으로 구성되어 있습니다. 자세한 내용은 Squads 공식 웹사이트를 참조하십시오."},
    ...
    {"system_settings_random_pin_pad", "랜덤 PIN 패드"},
    ...
    {"tap_to_see_more", "··· 더 많은 지갑을 보려면 탭하세요"},
    {"token_details", "토큰 세부 정보"},
    {"token_in_alt_desc", "이 SOL 트랜잭션의 원시 데이터에는 정확한 토큰 유형이 지정되어 있지 않습니다. 소프트웨어 지갑에서 특정 토큰 유형을 확인하십시오."},
    {"ton_assets_manage_notice", "TON 지갑은 호환되지 않는 시드 구문으로 인해 Bitcoin이나 Ethereum과 같은 다른 메인넷 추가를 지원하지 않습니다."},
    ...
    {"usb_connection_notice", "연결 알림"},
    {"usb_connection_notice_desc", "%s 지갑 QR 코드 연결은 현재 사용할 수 없습니다. USB를 통해 연결하세요."},
    {"usb_connection_subtitle", "에어갭 모드"},
    {"usb_connection_title", "연결"},
    {"usb_connectioning_wallet_desc", "소프트웨어 지갑이 연결을 완료할 때까지 기다린 후 닫기를 클릭하세요."},
    {"usb_connectioning_wallet_title", "지갑 연결 중"},
    {"usb_transport_connect_desc", "소프트웨어 지갑이 USB를 통해 귀하의 Keystone에 연결을 요청하고 있습니다. 승인하려면 비밀번호를 입력하세요"},
    ...
    {"wallet_profile_single_sign_title_text", "싱글시그월렛"},
...
const static lv_i18n_phrase_t ru_singulars[] = {
    ...
    {"boot_secure_switch_btn", "Проверка загрузки"},
    {"boot_secure_switch_desc", "Отключение функции безопасной загрузки может привести к угрозам безопасности."},
    {"boot_secure_switch_text_title", "Проверка безопасности загрузки"},
    {"boot_secure_switch_title", "Проверка безопасности загрузки"},
    {"boot_update_desc1", "Устройство будет обновлено для безопасности, подготовьте его."},
    {"boot_update_desc2", "Батарея не менее 40%"},
    {"boot_update_desc3", "Подключен сетевой адаптер"},
    {"boot_update_desc4", "Этот процесс может занять до 5 минут. НЕ отключайте питание или выполняйте какие-либо операции."},
    {"boot_update_desc5", "Свяжитесь с нами"},
    {"boot_update_limit_desc", "Убедитесь, что устройство имеет не менее 40% заряда и подключено к источнику питания для продолжения."},
    {"boot_update_process_desc", "Устройство обновляется для повышения безопасности. Пожалуйста, не отключайте питание или выполняйте какие-либо операции."},
    {"boot_update_process_title", "Обновление безопасности..."},
    {"boot_update_title", "Обновление безопасности"},
    {"boot_version_not_match_desc", "Ваша текущая прошивка, возможно, пропустила необходимое обновление безопасности, пожалуйста, свяжитесь с #1BE0C6 support@keyst.one# для помощи."},
    ...
    {"chain_path_avax_c_desc", "C-Chain поддерживает DeFi и смарт-контракты, совместимые с EVM."},
    {"chain_path_avax_x_p_desc", "X/P-Chain использует Bech32 для передачи активов на основе UTXO и стейкинга."},
    ...
    {"connect_wallet_supported_wallet", "Поддерживаемые кошельки"},
    ...
    {"create_multi_wallet_co_sign_text", "Cо-подпись"},
    ...
    {"derivation_path_ltc_native_desc", "Адреса начинаются с «ltc1»"},
    {"derivation_path_ltc_nested_desc", "Адреса начинаются с «M»"},
    ...
    {"derivation_path_select_avax", "Выберите соответствующую цепочку Avalanche для вашей транзакции."},
    ...
    {"derivation_path_select_ltc", "Выберите тип адресов Litcoin, который вы хотите использовать"},
    ...
    {"error_box_low_power_desc", "Устройству необходимо минимум 40% заряда батареи для продолжения процесса."},
    ...
    {"firmware_update_desc1", "Убедитесь, что у вашего Keystone осталось не менее 40% заряда батареи."},
    ...
    {"import_ton_mnemonic_desc", "Сид-фраза соответствует форматам BIP39 и TON. Пожалуйста, выберите тип кошелька, который вы хотите создать: мультивалютный кошелек или только TON-кошелек."},
    {"import_ton_mnemonic_title", "Выберите ваш кошелек"},
    ...
    {"instruction_does_not_contain_token_info", "В необработанных данных этой транзакции SOL не указан точный тип токена и адрес чеканки. Пожалуйста, подтвердите конкретный тип токена в программном кошельке."},
    ...
    {"invaild_path_index_title", "Недопустимый индекс пути"},
    {"invaild_schemas_size", "Недопустимый размер схем"},
    {"invaild_schemas_size_big", "Размер схем слишком большой"},
    {"invalid_slip39_ada_con", "Кошелек Shamir Backup в настоящее время не поддерживает Cardano"},
    {"iota_max_amount_notice", "В моделях на основе объектов, таких как IOTA, Max означает передачу владения всей монетой, поэтому не отображается конкретная сумма."},
    ...
    {"manage_import_wallet_notice_desc2", "Надежно сохраняйте и проверяйте резервную копию кошелька. Неверные данные могут привести к потере средств. Будьте внимательны к точности информации для защиты активов."},
    {"manage_import_wallet_notice_title", "Проверьте информацию о кошельке"},
    {"manage_import_wallet_passphrase_error_desc", "Не удалось импортировать мультисиг; проверьте пароль и повторите."},
    ...
    {"manage_multi_wallet_passphrase_add_limit_desc", "Добавьте до 1 пассфразы мультиподписные кошельки"},
    {"manage_multi_wallet_set_default", "Установить в качестве текущего кошелька"},
    ...
    {"multi_wallet_no_psbt_file", "Нет PSBT-файлов"},
    ...
    {"nft_screen_set_success_desc", "Вы можете включить или отключить отображение NFT-заставки в настройках системы"},
    {"nft_screen_set_success_title", "Настройка успешно завершена"},
    {"nft_screen_set_title", "Как настроить заставку NFT?"},
    {"nft_screen_set_url", "https://keyst.one/t/3rd/nft"},
    {"nft_trans_title", "Перенос..."},
    {"nft_trans_updating_desc", "Займет около 1 минут"},
    {"nft_trans_updating_hint", "Не отключайте USB-кабель во время передачи данных"},
    ...
    {"power_requirements_hintbox_context", "Убедитесь, что устройство заряжено не менее 80% и подключено к источнику питания."},
    ...
    {"receive_doge_receive_change_address_limit", "Нельзя превысить 19."},
    ...
    {"receive_ltc_more_t_desc1", "1.Nested SegWit: переходный формат, где SegWit вложен в P2SH. Он обеспечивает лучшую эффективность, чем Legacy, и является наиболее часто используемым форматом благодаря широкой совместимости.\r\n2.Native SegWit: полностью нативный формат SegWit с более низкими комиссиями и меньшими размерами транзакций. Становится всё более популярным и поддерживается большинством основных кошельков и бирж."},
    {"receive_ltc_more_t_title1", "Узнайте разницу: вложенный SegWit и нативные пути деривации SegWit в LTC"},
    {"receive_more_t_qr_link", "https://keyst.one/t/3rd/faq"},
    ...
    {"recovery_mode_switch_desc", "Включив эту функцию, вы можете войти в режим восстановления, продолжайте только в том случае, если вам нужно восстановить свою систему."},
    {"recovery_mode_switch_text_title", "Режим восстановления"},
    {"recovery_mode_switch_title", "Режим восстановления"},
    ...
    {"rsa_confirm_hintbox_context", "Введите пароль, чтобы начать настройку блокчейна ARWEAVE, это займет около 10 минут. Убедитесь, что ваше устройство заряжено не менее 80% и подключено к USB."},
    ...
    {"sign_eth_operation_warn", "Эта операция/транзакция может изменить внутреннее состояние мультисиг-контракта. Пожалуйста, внимательно проверьте детали."},
    ...
    {"single_phrase_low_battery_desc", "Для продолжения процесса устройству требуется минимум 40% заряда батареи."},
    ...
    {"solana_squads_amount_desc", "Эта сумма является комиссией за развертывание и состоит из трех частей. Для получения подробной информации, пожалуйста, обратитесь к официальному сайту Squads."},
    ...
    {"system_settings_random_pin_pad", "Рандомизированная PIN"},
    ...
    {"tap_to_see_more", "··· Нажмите, чтобы увидеть больше кошельков"},
    ...
    {"ton_assets_manage_notice", "TON кошелек не поддерживает добавление других основных сетей, таких как Bitcoin или Ethereum, из-за несовместимой сид-фразы."},
    ...
    {"usb_connection_notice", "Подключение уведомление"},
    {"usb_connection_notice_desc", "Подключение через QR-код %s Wallet сейчас недоступно. Пожалуйста, подключитесь через USB."},
    {"usb_connection_subtitle", "Режим воздушного зазора"},
    {"usb_connection_title", "Соединение"},
    {"usb_connectioning_wallet_desc", "Пожалуйста, подождите, пока программный кошелек завершит подключение, затем нажмите, чтобы закрыть."},
    {"usb_connectioning_wallet_title", "Подключение кошелька"},
    {"usb_transport_connect_desc", "Программный кошелек запрашивает подключение к вашему Keystone через USB. Введите ваш пароль для подтверждения."},
    ...
    {"wallet_profile_single_wallet_title", "Кошелек c одной подписью"},
    {"wallet_setting_add_wallet", "Добавить"},
    {"wallet_setting_add_wallet_confirm", "Понятно"},
    {"wallet_setting_add_wallet_limit", "Лимит исчерпан"},
...
const static lv_i18n_phrase_t zh_cn_singulars[] = {
    ...
    {"boot_secure_switch_btn", "启动安全检查"},
    {"boot_secure_switch_desc", "禁用安全启动可能带来安全风险。"},
    {"boot_secure_switch_text_title", "启动安全检查"},
    {"boot_secure_switch_title", "启动安全检查"},
    {"boot_update_desc1", "设备将更新以提高安全性；请确保已准备好。"},
    {"boot_update_desc2", "确保电池电量至少40%"},
    {"boot_update_desc3", "电源适配器已连接"},
    {"boot_update_desc4", "这个过程可能需要5分钟。不要断开电源或执行任何操作。"},
    {"boot_update_desc5", "联系我们"},
    {"boot_update_limit_desc", "确保设备至少有40%的电量并连接到电源源以继续。"},
    {"boot_update_process_desc", "设备正在更新以提高安全性。请不要断开电源或执行任何操作。"},
    {"boot_update_process_title", "安全更新正在进行中..."},
    {"boot_update_title", "安全升级"},
    {"boot_version_not_match_desc", "您当前的固件可能错过了必要的安全升级，请联系 #1BE0C6 support@keyst.one# 以获取帮助。"},
    ...
    {"chain_path_avax_c_desc", "C-Chain支持与EVM兼容的DeFi和智能合约。"},
    {"chain_path_avax_x_p_desc", "X/P-Chain使用Bech32进行基于UTXO的资产转移和质押。"},
    {"change_entropy", "更改熵"},
    ...
    {"connect_wallet_supported_wallet", "支持的钱包"},
    ...
    {"create_multi_wallet_co_sign_text", "共同签署"},
    ...
    {"error_box_low_power_desc", "设备需要至少 40% 的电量才能继续操作。"},
    ...
    {"import_ton_mnemonic_desc", "助记词同时符合 BIP39 和 TON 格式。请选择您要创建的钱包类型：多币种钱包或仅限 TON 的钱包。"},
    {"import_ton_mnemonic_title", "选择您的钱包"},
    ...
    {"instruction_does_not_contain_token_info", "此 SOL 交易的原始数据未指定确切的代币类型和铸造地址。请在软件钱包中确认具体的代币类型。"},
    {"invaild_account_path", "无效的账户路径"},
    {"invaild_account_path_notice", "请在软件钱包中重新输入路径并重试。"},
    {"invaild_ada_path", "路径不受支持"},
    {"invaild_ada_path_con", "选择的路径不受支持。请在软件钱包中选择一个有效的路径。"},
    {"invaild_derive_type", "无效的派生类型"},
    {"invaild_derive_type_con", "不支持的派生类型"},
    {"invaild_path_index_big", "ada 派生路径索引过大"},
    {"invaild_path_index_con", "ada 派生路径非法"},
    {"invaild_path_index_title", "无效的路径索引"},
    {"invaild_schemas_size", "无效的架构大小"},
    {"invaild_schemas_size_big", "架构大小过大"},
    {"invalid_slip39_ada_con", "分片助记词钱包目前不支持 Cardano"},
    {"iota_max_amount_notice", "在基于对象的模型（如IOTA）中，Max表示转移整个币的所有权，因此不显示具体金额。"},
    ...
    {"manage_import_wallet_passphrase_error_desc", "导入多签钱包失败，请确认口令并重试。"},
    ...
    {"manage_multi_wallet_passphrase_add_limit_desc", "添加最多1个密码短语多签钱包"},
    ...
    {"nft_screen_set_success_desc", "您可以在系统设置中打开或关闭NFT屏保显示"},
    {"nft_screen_set_success_title", "设置成功"},
    {"nft_screen_set_title", "如何设置 NFT 屏幕保护程序?"},
    {"nft_screen_set_url", "https://keyst.one/t/3rd/nft"},
    {"nft_trans_title", " 传输中..."},
    {"nft_trans_updating_desc", "大约需要1分钟"},
    {"nft_trans_updating_hint", "传输过程中请勿断开USB电缆"},
    ...
    {"receive_doge_receive_change_address_limit", "不能超过19"},
    ...
    {"receive_ltc_more_t_desc1", "1.Nested SegWit：一种过渡格式，将 SegWit 嵌套在 P2SH 中。它比 Legacy 更高效，并因广泛的兼容性而成为最常用的格式。\r\n2.Native SegWit：完全原生的 SegWit 格式，手续费更低，交易体积更小。越来越受欢迎，并得到大多数主流钱包和交易所的支持。"},
    {"receive_ltc_more_t_title1", "了解区别：LTC 中的 Nested SegWit 与 Native SegWit 派生路径"},
    {"receive_more_t_qr_link", "https://keyst.one/t/3rd/faq"},
    ...
    {"recovery_mode_switch_desc", "启用此功能后，您可以进入恢复模式，仅在需要恢复系统时继续。"},
    {"recovery_mode_switch_text_title", "恢复模式"},
    {"recovery_mode_switch_title", "恢复模式"},
    ...
    {"show_checksum", "显示校验和"},
    {"sign_eth_operation_warn", "此操作/交易可能会更改多签合约的内部状态。请仔细审查详情。"},
    ...
    {"single_phrase_low_battery_desc", "请确保您的设备电量高于 40%."},
    ...
    {"solana_squads_amount_desc", "该金额是部署费用,由三部分组成。详情请参考 Squads 官方网站。"},
    ...
    {"system_settings_random_pin_pad", "随机化PIN键盘"},
    ...
    {"tap_to_see_more", "··· 点击查看更多钱包"},
    {"token_details", "代币详情"},
    {"token_in_alt_desc", "此 SOL 交易的原始数据未指定确切的代币类型。请在软件钱包中确认具体的代币类型。"},
    {"ton_assets_manage_notice", "TON钱包不支持添加其他主网（如比特币或以太坊），因为助记词不兼容。"},
    ...
    {"usb_connection_notice", "连接通知"},
    {"usb_connection_notice_desc", "%s 钱包 QR 代码连接目前不可用。请通过 USB 连接。"},
    {"usb_connection_subtitle", "气隙模式"},
    {"usb_connection_title", "连接方式"},
    {"usb_connectioning_wallet_desc", "请等待软件钱包完成连接，然后点击关闭。"},
    {"usb_connectioning_wallet_title", "正在连接钱包"},
    {"usb_transport_connect_desc", "软件钱包正在请求通过USB连接到您的Keystone,请输入您的密码以批准"},
    ...
    {"wallet_profile_single_sign_title_text", "单签钱包"},
